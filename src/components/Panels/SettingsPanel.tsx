...
import { Settings, Save, Bell, Shield, Database, Mail, Globe, Key, RefreshCw } from 'lucide-react';
...
export const SettingsPanel: React.FC = () => {
  ...
  const [settings, setSettings] = useState({
    general: {
      companyName: 'Ajio Seller Central',
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="text-sm text-gray-500">New orders and status changes</div>
          </div>
          <label className="relative inline-flex items-center cursor-pointer">
            <input
              type="checkbox"
        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="font-medium">Return Alerts</div>
            <div className="text-sm text-gray-500">Return requests and updates</div>
          </div>
          <label className="relative inline-flex items-center cursor-pointer">
            <input
              type="checkbox"
              checked={settings.notifications.returnAlerts}
              onChange={(e) => handleSettingChange('notifications', 'returnAlerts', e.target.checked)}
              className="sr-only peer"
            />
            <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
          </label>
  ...
  const renderIntegrationsSettings = () => (
    <div className="space-y-6">
      <div>
        <h4 className="font-medium text-gray-900 mb-4">Shipping Partner APIs</h4>
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Delhivery API Key</label>
            <div className="relative">
              <input
                type="password"
                value={settings.integrations.delhiveryApiKey}
                onChange={(e) => handleSettingChange('integrations', 'delhiveryApiKey', e.target.value)}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Shadowfax API Key</label>
            <div className="relative">
              <input
                type="password"
                value={settings.integrations.shadowfaxApiKey}
                onChange={(e) => handleSettingChange('integrations', 'shadowfaxApiKey', e.target.value)}
                className="w-full px-3 py-2 pr-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                placeholder="Enter API key"
              />
              <Key className="absolute right-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-400" />
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Xpressbees API Key</label>
            <div className="relative">
              <input
                type="password"
                value={settings.integrations.xpressbeesApiKey}
                onChange={(e) => handleSettingChange('integrations', 'xpressbeesApiKey', e.target.value)}
                className="w-full px-3 py-2 pr-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                placeholder="Enter API key"
              />
              <Key className="absolute right-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-400" />
